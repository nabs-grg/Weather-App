	...
	var Weather = React.createClass({
		...
		render: function render() {
			...
			var _state = this.state,
			    ...
			    temp = _state.temp; //var location=this.state.location //location state exist here
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OPEN_WEATHER_MAP_URL = 'http://api.openweathermap.org/data/2.5/weather?appid=747d90314c9a7bcd1f4f21ef559f4f88&units=metric';
